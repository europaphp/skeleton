...
class UriTest extends UnitAbstract
{
    ...
    public function suffixesContainingPartsWithDotsButNoSuffix()
    {
        $uri = new Uri('http://test.com/test.something/test');
        $this->assert(!$uri->getSuffix(), 'No suffix should have been set.');
    }
}