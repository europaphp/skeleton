...
if (class_exists('Europa_Sniffs_Commenting_FileCommentSniff', true) === false) {
    $error = 'Class Europa_Sniffs_Commenting_FileCommentSniff not found';
    throw new PHP_CodeSniffer_Exception($error);
}
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Europa_Sniffs_Commenting_ClassCommentSniff extends Europa_Sniffs_Commenting_FileCommentSniff
{
