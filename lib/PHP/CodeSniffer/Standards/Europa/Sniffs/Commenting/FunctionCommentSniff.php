 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Europa_Sniffs_Commenting_FunctionCommentSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if (count($params) > 1) {
            ...
            if ($newlineSpan !== 2) {
                $error = 'There must be exactly one blank line before the tags in function comment. If there is, then you probably need to enter a description before the tags.';
                if ($long !== '') {
