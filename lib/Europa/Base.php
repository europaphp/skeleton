...
abstract class Europa_Base
{
	...
	public function __construct($config = null, $instanceName = 'default')
	{
		...
		$this->_config                   = self::extend($this->_config, $config);
	 ...
	 * 
	 * @name extend
	 * @desc Sets the values of $var1 to $var2, adding in any key/value paris if necessary.
	 * 
	 * @param  Mixed $var1 - An Object or Array.
	 * @param  Mixed $var2 - An Object or Array.
	 * 
	 * @return Mixed
	 */
	static public function extend($var1, $var2)
	{
