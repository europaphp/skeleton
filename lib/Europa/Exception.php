...
class Europa_Exception extends Exception
{
	 ...
	 * 
	 * @name __construct
	 * @desc Constructs the Exception class and supplies a default exception message/output.
	 * 
	 ...
	 *       in chronological order, ascending whereas most call-stacks are displayed in descending order.
	 *  
	 * @return Void
	 */
	 ...
	 * 
	 * @name handle
	 * @desc Provides a way to throw any type of exception without wrapping it in a try/catch block. This is
	 *       the default exception handler in Eruopa and does the exact same thing as if an exception were
	 *       thrown from a catch statement. Utilizes the __toString method of whatever exception was thrown.
	 */
