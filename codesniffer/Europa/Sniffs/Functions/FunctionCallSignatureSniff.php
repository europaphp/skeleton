...
/**
 * Europa_Sniffs_Functions_FunctionCallSignatureSniff.
 *
 * PHP version 5
 *
 * @category  PHP
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Europa_Sniffs_Functions_FunctionCallSignatureSniff implements PHP_CodeSniffer_Sniff
{
	/**
	 ...
	 * @param int $stackPtr The position of the current token in the stack
	 * passed in $tokens.
	 * @param int $openBracket The position of the opening bracket in the stack
	 * passed in $tokens.
	 ...
	 * @param int $stackPtr	The position of the current token in the stack
	 * passed in $tokens.
	 * @param int openBracket The position of the openning bracket in the stack
	 * passed in $tokens.
	 * @param array $tokens The stack of tokens that make up the file.
	 * @return void
	 */
		...
		for ($i = ($openBracket + 1); $i < $closeBracket; $i++) {
			...
			if ($tokens[$i]['line'] !== $lastLine) {
				...
				if ($tokens[$i]['line'] === $tokens[$closeBracket]['line']) {
					...
					// multi-line funciton call needs an extra indentation line
				...
				if ($expectedIndent !== $foundIndent) {
					$error = 'Multi-line function call not indented correctly;'
					       . " expected $expectedIndent spaces but found $foundIndent";
